...
- `Constructor.prototype` 的 `[[Prototype]]` 为 `Object.prototype`，实现更长的原理就是要将 `Constructor.prototype` 的 `[[Prototype]]` 指向别的构造函数的原型，即：`Constructor.prototype` 的 `[[Prototype]]` 为 `OtherConstructor.prototype`
