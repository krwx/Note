...
使用 `Object.setPrototypeOf()` 函数设置 `Constructor.prototype` 的 _原型_ 为其他构造函数的 `prototype` 来延长原型链。

即：`Constructor.prototype` 的 `[[Prototype]]` 为 `OtherConstructor.prototype`

```js
Object.setPrototypeOf(obj, prototype)
// obj：要设置 prototype 的原型的构造函数。
// prototype：其他构造函数的 prototype。
```
...
- `Object.setPrototypeOf()` 函数的第二个参数是直接为第一个参数的原型
- 直接设置 `Constructor.prototype` = 其他 `Constructor.prototype` 不是继承，设置 `Constructor.prototype` 的原型 = 其他 `Constructor.prototype` 才是继承
...
var obj = new Child();
// obj ---> Child.prototype ---> Person 实例对象 ---> Person.prototype ---> Object.prototype ---> null

Child.prototype = Person.prototype;
var obj = new Child();
// obj ---> Child.prototype == Person.prototype ---> Object.prototype ---> null
```
