...
- [http、浏览器](#http浏览器)
  ...
  - [29. 线上项目出现白屏问题，怎么快速定位原因？](#29-线上项目出现白屏问题怎么快速定位原因)
...
## 29. 线上项目出现白屏问题，怎么快速定位原因？

1. 打开浏览器开发者工具 Console 面板，排查JS语法错误、资源加载404/500问题
2. 查看 Network 面板，确认核心资源（入口JS/CSS）是否加载成功、加载顺序是否正确
3. 检查 Application 面板的 LocalStorage/SessionStorage ，排查缓存数据格式异常导致的解析失败
4. 开启 Source Map ，定位压缩混淆代码对应的原始报错位置
