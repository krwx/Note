...
- [vue 面试问题](#vue-面试问题)
  ...
  - [12. Vue3 中组件的响应式数据更新后，视图为什么能自动刷新？什么时候会出现数据更新视图不更新的情况？](#12-vue3-中组件的响应式数据更新后视图为什么能自动刷新什么时候会出现数据更新视图不更新的情况)
...
## 12. Vue3 中组件的响应式数据更新后，视图为什么能自动刷新？什么时候会出现数据更新视图不更新的情况？
