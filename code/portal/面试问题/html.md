...
- [html 问题](#html-问题)
  - [1. 表单对象 名称是什么属性，提交是什么属性，大数据处理是什么属性，提交后的处理程序是什么属性](#1-表单对象-名称是什么属性提交是什么属性大数据处理是什么属性提交后的处理程序是什么属性)
  - [2. 表单格 行合并是什么属性，列合并是什么属性](#2-表单格-行合并是什么属性列合并是什么属性)
  - [3. html5有哪些新特性、移除了那些元素？](#3-html5有哪些新特性移除了那些元素)
  - [4. HTML5 的离线储存怎么使⽤，⼯作原理能不能解释⼀下？](#4-html5-的离线储存怎么使作原理能不能解释下)
