...
面试官好，我叫陈广鸿，今年27岁，毕业于武汉理工大学，有5年开发经验。目前就职于德迅货运代理公司，主要负责 SeatratesView 系统的数据支持与后台任务框架搭建，我搭建了后端 Celery 任务框架并使用 python 和 pandas 对业务数据进行处理及分析。在技术方面，我能熟悉进行 Python 开发，能熟练使用 pandas 进行数据处理。以上就是我的基本情况，谢谢。
