...
面试官好，我叫陈广鸿，今年27岁，毕业于武汉理工大学，有5年开发经验。第一份工作就职于中兴通讯股份有限公司，负责 UME 云化智能管理系统的网页开发，根据客户需求实现业务相关功能，搭起了业务界面的通用框架供其他业务使用，基于公司自研拓扑组件实现业务的拓扑展示。目前就职于德迅货运代理公司，主要负责 SearatesView 系统的网页开发，实现了富文本邮件编辑与发送的功能和访问服务器 Flower 页面的功能，优化 vite 配置，搭起了后端 Celery 的主程序。在技术方面，我能熟练掌握 Vue 全家桶进行项目开发，熟悉 Vite 构建工具的基本配置与优化，也熟悉 Python、Celery 开发。以上就是我的基本情况，谢谢。
